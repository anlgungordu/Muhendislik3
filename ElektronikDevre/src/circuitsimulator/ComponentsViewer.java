...
public class ComponentsViewer extends JPanel {
    ...
    public ComponentsViewer() {
        ...
        System.out.println("Büyüklük : " + this.getPreferredSize().height);

        list.addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    String name = (String) list.getSelectedValue();
                    System.out.println("Seçilen eleman: " + name);
        ...
        JButton pick = new JButton("Bileşenleri Seç");
        ...
        this.add(new JLabel("       Bileşenleri Görüntüle"));
